...
void  PREDICTOR::UpdatePredictor(UINT64 PC, OpType opType, bool resolveDir, bool predDir, UINT64 branchTarget){
  ...
  if(resolveDir == TAKEN){
	...
	if(bimodalCounter != 2 && bimodalCounter != PHT_CTR_MAX && bimodalCounter != 3){
	...
	if(bimodalCounter != 5 && bimodalCounter != 0 && bimodalCounter !=  4){
		
		bimodal[BimodalIndex]--;
		
	}
	else if(bimodalCounter == 5){
