...
#define FILTER_UPDATES_USING_BTB     1     //if 1 then the BTB updates are filtered for a given branch if its marker is not btbDYN
#define FILTER_PREDICTIONS_USING_BTB 1     //if 1 then static predictions are made (btbANSF=1 -> not-taken, btbATSF=1->taken, btbDYN->use conditional predictor)
